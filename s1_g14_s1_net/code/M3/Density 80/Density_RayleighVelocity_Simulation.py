...
lambda0UAV = 1e-6 # drone density [UAVs/m^2]
R_UAV = 1e4 
NumUAV_Initial = lambda0UAV * np.pi * R_UAV**2
vMean = 80 # [km/h] # Average speed of the drone, which is used to calculate the scale parameter for the Rayleigh distribution.
vMean = vMean / 3.6 # [m/s] 
